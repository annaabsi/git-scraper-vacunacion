...
try:
    ...
    if hash_saved==hash_downloaded:
        ...
        bins = [0,18,30,40,50,60,70,80,df['EDAD'].max()+1]
        labels = ['Menores de 18 años','18 a 29 años','30 a 39 años','40 a 49 años','50 a 59 años','60 a 69 años','70 a 79 años','80 años a más']
        poblacion_por_grupo_etario = [9690442,6303670,5031117,4183174,3277134,2221241,1271842,647355] 
        df_edades = df
